...
<html>
<head>
	<title>Women | Onlineshop</title>
	<link rel="icon" href="res/onlineshop.jpg" sizes="16x16">
...
<div id="logo">
	<a href="fandom.php">
		<center><img src="res/onlineshop.jpg" width="70%"></center>
	</a>
</div>
...
<div id="sidebar">
	<ul>
		...
		<li><a href="https://forms.gle/p4hd8fFsDKY6vbxX9" target="_blank"><table><tr><td><img src="res/icons/request.png" /></td>
		<td>&nbsp;Feedback Here&nbsp;</td><td><img src="res/icons/new_page.png" /></td></tr></table></a></li>
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Clothing' AND fandom='women' ORDER BY id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<img src="res/women/{$obj->product_img_name}">
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Accessories' AND fandom='women' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='footwear' AND fandom='women' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<footer class="container">
	<div class="row">	
		<p class="col-sm-6">
			&copy; 2019 Onlineshop <i style="color: #fd4b4b;">&nbsp; | &nbsp;</i>S.Saikumar Rao
		</p>

		<ul class="col-sm-6">
			<li class="col-sm-1">
				<a href="mailto:siddannagarisaikumar@gmail.com" target="_blank">
					<img src="res/social media/help.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://www.facebook.com/saikumar.rao.39" target="_blank">
					<img src="res/social media/facebook.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://plus.google.com/siddannagarisaikumar@gmail.com" target="_blank">
					<img src="res/social media/google-plus.png">
				</a>
			</li>
			<li class="col-sm-1">
				<a href="https://www.instagram.com/S.SAI_KUMAR_RAO" target="_blank">
